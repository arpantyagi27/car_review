...
for query in querys:
	...
	driver = webdriver.Chrome('path to the location of the driver')
	...
	for i in range(1, 500):
		...
		# range(1, n) will capture images 1 to n-1 of the search results
		try:
		...
		# XPath of each image
			...
			img.screenshot(f'path of the location'+'name'+str(i)+'.png')
